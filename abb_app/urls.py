...
from .views import (
    ...
    update_single_occurrence_abbreviations,
...
urlpatterns = [
    ...
    path('update_single_occurrence_abbreviations/',
         update_single_occurrence_abbreviations,
         name='update_single_occurrence_abbreviations'),
    path('update_abbreviation/', update_abbreviation,
         name='update_abbreviation'),
    path('update_card_state/', update_card_state,
